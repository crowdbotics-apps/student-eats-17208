"""student_eats_17208 URL Configuration
...
admin.site.site_header = "Student Eats"
admin.site.site_title = "Student Eats Admin Portal"
admin.site.index_title = "Student Eats Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Student Eats API",
        default_version="v1",
        description="API documentation for Student Eats App",
    ),
    public=True,
